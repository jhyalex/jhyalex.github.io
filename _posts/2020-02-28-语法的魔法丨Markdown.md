---
layout:     post
title:      语法的魔法丨Markdown
subtitle:   Markdown 是一个 Web 上使用的文本到HTML的转换工具，可以通过简单、易读易写的文本格式生成结构化的HTML文档。目前 github、Stackoverflow 等网站均支持这种格式。
date:       2020-02-28
author:    Riku 
header-img: img/Grammar_20200228.png
catalog: true
tags:
    - 语法的魔法
    - 技术与艺术
...
> 本文转载自[Github/Riku](https://github.com/riku)
